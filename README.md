...
- Production Swagger UI: https://aqtilink.live/user-docs/swagger-ui.html
- Production OpenAPI JSON: https://aqtilink.live/user-docs/v3/api-docs
- Local Swagger UI: http://localhost:8080/user-docs/swagger-ui.html
- Local OpenAPI JSON: http://localhost:8080/user-docs/v3/api-docs
